      ...
      ConfirmationSheet(
        ...
        onTap: () {
          ...
          if (chatUserRoom.type == 2) {
            ...
            db.collection(FirebaseConst.users).doc(myUser?.firebaseId()).collection(FirebaseConst.userList).doc('${chatUserRoom.userIdOrRoomId}').update({FirebaseConst.deletedId: date});
          }
        },
      ),
    );
